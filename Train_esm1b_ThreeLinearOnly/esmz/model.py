...
class ProteinBertModel(nn.Module):
    ...
    def _init_submodules_common(self):
        ...
        self.embed_tokens_1 = nn.Embedding(
            self.alphabet_size, 160, padding_idx=self.padding_idx, 
        )
        ...
        ################改
        self.Linear_layer0 = nn.Linear(1280, 640)
        self.layer_block0 = TransformerLayer(
                    # self.args.embed_dim, self.args.ffn_embed_dim, self.args.attention_heads,
                    640, 2560, self.args.attention_heads,
                    add_bias_kv=(self.model_version != 'ESM-1b'),
                    use_esm1b_layer_norm=(self.model_version == 'ESM-1b'),
                )
        self.Linear_layer1 = nn.Linear(640, 320)
        ...
        self.layer_block1 = TransformerLayer(
                    # self.args.embed_dim, self.args.ffn_embed_dim, self.args.attention_heads,
                    320, 1280, self.args.attention_heads,
                    add_bias_kv=(self.model_version != 'ESM-1b'),
                    use_esm1b_layer_norm=(self.model_version == 'ESM-1b'),
                )
        self.Linear_layer2 = nn.Linear(320, 160)
        ...
        self.layer_block2 = TransformerLayer(
                    # self.args.embed_dim, self.args.ffn_embed_dim, self.args.attention_heads,
                    160, 640, self.args.attention_heads,
                    add_bias_kv=(self.model_version != 'ESM-1b'),
                    use_esm1b_layer_norm=(self.model_version == 'ESM-1b'),
                )
        self.Linear_layer3 = nn.Linear(160, 80)
    ...
    def _init_submodules_esm1b(self):
        ...
        self.emb_layer_norm_after1 = ESM1bLayerNorm(160)
    ...
    def forward(self, tokens, repr_layers=[], need_head_weights=False, return_contacts=False):
        ...
        padding_mask_again = padding_mask
